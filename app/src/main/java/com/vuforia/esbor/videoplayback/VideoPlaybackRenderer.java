...
import com.vuforia.esbor.utils.SampleMath;
import com.vuforia.esbor.utils.SampleUtils;
import com.vuforia.esbor.utils.Texture;
import com.vuforia.esbor.videoplayback.VideoPlayerHelper.MEDIA_STATE;
import com.vuforia.esbor.videoplayback.VideoPlayerHelper.MEDIA_TYPE;
...
public class VideoPlaybackRenderer implements GLSurfaceView.Renderer
{
    ...
    void renderFrame()
    {
        ...
        for (int tIdx = 0; tIdx < state.getNumTrackableResults(); tIdx++)
        {
            ...
            // calculation
            if (imageTarget.getName().equalsIgnoreCase("agiasofia-exterior2"))
                currentTarget = VideoPlayback.STONES;
            else if (imageTarget.getName().equalsIgnoreCase("agiasofia-interior"))
